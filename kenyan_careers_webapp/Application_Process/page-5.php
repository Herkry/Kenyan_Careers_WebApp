...
<div id="news" class="container-fluid bg-grey">
    ...
    <br>
    <div class="col-sm-8">
    <a href="/Kenyan_Careers_WebApp/kenyan_careers_webapp/Application_Process/applicationDetails.php"><button type="button" class="btn btn-success">Previous</button></a> 
    </div>
    <div class="col-sm-4">
    <a href="#"><button type="button" class="btn btn-warning">Next</button></a>
    </div>
    </div>
</div>
