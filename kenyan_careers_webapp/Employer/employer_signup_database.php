...
//Utilises PHPMailer path: phpmailer/PHPMailerAutoload.php
    ...
    if (isset($_POST['submit']))
   {
      ...
      if ($password = $cpassword)
      {
        ...
        $sql = "INSERT INTO employer_details(emp_logo,emp_category, emp_name, emp_email, emp_phone, emp_location, emp_address, emp_url, emp_password) values ('$logo','$category','$name','$email','$phone','$location','$address','$url','$password')";

        if ($conn->query($sql) === TRUE)
                {
                   require_once('/opt/lampp/htdocs/Kenyan_Careers_WebApp/kenyan_careers_webapp/Employer/phpmailer/PHPMailerAutoload.php');
