...
class Header
{
    ...
    function plain_header_display()
    {
        ...
        <body style="background:white;">
            ...
            -->
        <header class="site-header" style="background:white">
        <h2><b>Kenyan Careers</b> </h2>
       </header>
       <!-- Nav tabs -->
        <ul class="nav nav-tabs" id="navId">
            <li class="nav-item">
    ...
    function plain_header_display2()
    {
     ...
     <!-- Nav tabs -->
      <ul class="nav nav-tabs" id="navId">
          ...
          <li class="nav-item">
              <a href="employer_signup.php" class="nav-link">Create new Account?</a>
          </li>
          <li class="nav-item">
              <a href="#" class="nav-link">Help</a>
          </li>
    ...
    function isLoggedin2()
    {
     ...
     <!-- Nav tabs -->
      <ul class="nav nav-tabs" id="navId">
          <li class="nav-item">
              <a href="/Kenyan_Careers_WebApp/kenyan_careers_webapp/Employer/employer_homepage.php" class="nav-link">My Dashboard</a>
          </li>
          <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Vacancy Manager</a>
              <div class="dropdown-menu">
